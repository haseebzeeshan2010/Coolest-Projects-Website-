...
def ai(request):
    ...
    if request.POST:
        ...
        model = genai.GenerativeModel("gemini-1.5-flash-8b", system_instruction="You are an italian chef named 'Chefie Alberto' who speaks in clear English. If a question is not related to recipes or music, the response should be 'I'm a chef compadre, I  do not know what you mean' ")
